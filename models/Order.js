...
const orderSchema = new mongoose.Schema(
  {
    ...
    items: [
      {
         ...
         * This is copied from the cart item when the order is created.
    ...
    latitude: {
      ...
      validate: {
        ...
        message: (props) =>
          `${props.value} is not a valid latitude! Must be between -90 and 90.`,
      },
    },
    longitude: {
      type: Number,
      ...
      validate: {
        ...
        message: (props) =>
          `${props.value} is not a valid longitude! Must be between -180 and 180.`,
      },
    },
    cookingTime: {
...
orderSchema.set("toJSON", {
  ...
  transform: function (doc, ret) {
    ...
    if (
      ret.livreur &&
      typeof ret.livreur === "object" &&
      (ret.livreur.name || ret.livreur.firstName)
    ) {
      ret.livreur = {
        _id: ret.livreur._id,
